...
class Login:
    def __init__(self, root):
        ...
        # bg image
        img = Image.open(r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\window-main\project pics\lbg.png")
        ...
        leftimg = Image.open(r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\window-main\project pics\new.png")
        ...
        # sign up part
        signimg = Image.open(r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\window-main\project pics\hyy.png")
        ...
        userimg = Image.open(
            r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\window-main\project pics\username_icon.png")
        ...
        self.txtpwd = Entry(self.lgn_frame, highlightthickness=0, relief=FLAT, bg='black', fg='white',
                            font=('comic sans ms', 15, 'bold'), show='*', cursor='hand2')
        ...
        psdimg = Image.open(
            r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\window-main\project pics\password_icon.png")
        ...
        lgnbuttonimg = Image.open(
            r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\window-main\project pics\login2.png")
        ...
        signbuttonimg = Image.open(
            r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\window-main\project pics\s3.png")
        ...
        showbuttonimg = Image.open(
            r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\window-main\project pics\show.png")
        ...
        hidebuttonimg = Image.open(
            r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\window-main\project pics\hide.png")
    ...
    def hide(self):
        self.photoimg7 = ImageTk.PhotoImage(self.showbuttonimg)
        swbl = Button(self.root, image=self.photoimg7, bg='black', activebackground='black', cursor='hand2', bd=0,
                      command=self.show)
        swbl.place(x=1275, y=475, width=15, height=15)
        self.txtpwd(show='*')
