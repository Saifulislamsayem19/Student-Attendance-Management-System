...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\Python_Test_Projects\Images_GUI\loginBg1.jpg")
        ...
        img1=Image.open(r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\Python_Test_Projects\Images_GUI\log1.png")
        ...
        #label1 
        username =lb1= Label(frame1,text="Email Address:",font=("times new roman",15,"bold"),fg="white",bg="#002B53")
        ...
        loginbtn=Button(frame1,command=self.login,text="Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="white",bg="#25ABE2",activeforeground="white",activebackground="#007ACC")
        loginbtn.place(x=33,y=320,width=270,height=35)

        # Creating Button Register
        loginbtn = Button(frame1, command=self.reg, text="Create New Account", font=("times new roman", 12, "bold"), bd=0,
                          relief=RIDGE, fg="black", bg="#00AD7F", activeforeground="white", activebackground="#007ACC")
        loginbtn.place(x=33, y=380, width=140, height=25)

        # Creating Button Forget Password
        loginbtn = Button(frame1, command=self.forget_pwd, text="Forget Password", font=("times new roman", 12, "bold"), bd=0,
                          relief=RIDGE, fg="#002B53", bg="#FF2E33", activeforeground="white", activebackground="#007ACC")
        loginbtn.place(x=186, y=380, width=120, height=25)

        # loginbtn = Button(frame1, text="Don't have an account?", font=("times new roman", 12, "bold"), bd=0,
        ...
        # loginbtn.place(x=33,y=390,width=50,height=20)
        #
        #
        # # Creating Button Forget
        # loginbtn=Button(frame1,command=self.forget_pwd,text="Forget Your Password?",font=("times new roman",10,"bold"),bd=0,relief=RIDGE,fg="white",bg="#002B53",activeforeground="orange",activebackground="#002B53")
        # loginbtn.place(x=150,y=400,width=155,height=20)
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            conn = mysql.connector.connect(username='root', password='Saiful2000',host='localhost',database='face_recognition',port=3306)
...
# This part is image labels setting start 
        # first header image  
        img=Image.open(r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\Python_Test_Projects\Images_GUI\banner.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\Python_Test_Projects\Images_GUI\std1.jpg")
        ...
        det_img_btn=Image.open(r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\Python_Test_Projects\Images_GUI\det1.jpg")
        ...
        att_img_btn=Image.open(r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\Python_Test_Projects\Images_GUI\att.jpg")
        ...
        # Start below buttons.........
         # Train   button 5
        tra_img_btn=Image.open(r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\Python_Test_Projects\Images_GUI\tra1.jpg")
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\Python_Test_Projects\Images_GUI\qr1.png")
        ...
        # exit   button 8
        exi_img_btn=Image.open(r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\Python_Test_Projects\Images_GUI\exi.jpg")
