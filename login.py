...
class Login:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(
            file=r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\Python_Test_Projects\Images_GUI\loginBg1.jpg")
        ...
        img1 = Image.open(
            r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\Python_Test_Projects\Images_GUI\log1.png")
        ...
        # label1
        username = lb1 = Label(frame1, text="Email Address:", font=("times new roman", 15, "bold"), fg="white",
                               bg="#002B53")
        ...
        loginbtn = Button(frame1, command=self.login, text="Login", font=("times new roman", 15, "bold"), bd=0,
                          relief=RIDGE, fg="white", bg="#25ABE2", activeforeground="white", activebackground="#007ACC")
        loginbtn.place(x=33, y=320, width=270, height=35)

        # Creating Button Register
        loginbtn = Button(frame1, command=self.reg, text="Create New Account", font=("times new roman", 12, "bold"),
                          bd=0,
        ...
        loginbtn = Button(frame1, command=self.forget_pwd, text="Forget Password", font=("times new roman", 12, "bold"),
                          bd=0,
                          relief=RIDGE, fg="#002B53", bg="#FF2E33", activeforeground="white",
...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        # backgorund image
        bg1 = Image.open(r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\Python_Test_Projects\Images_GUI\bg.jpg")
        ...
        det_img_btn = Image.open(
            r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\Python_Test_Projects\Images_GUI\facialrecognition.png")
        ...
        att_img_btn = Image.open(
            r"C:\Users\Saiful IN\Desktop\My Program\PythonProject\Python_Test_Projects\Images_GUI\facial_0.jpg")
